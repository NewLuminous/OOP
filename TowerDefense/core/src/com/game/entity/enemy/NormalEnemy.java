...
public class NormalEnemy extends Enemy {
    public NormalEnemy(World world, int posx, int posy) {
    ...
    public float getTextureHeight() {
        return (float)getTextures()[0].getHeight() * GameConfig.VIEWPORT_HEIGHT / GameConfig.SCREEN_HEIGHT;
    }

    @Override
    public float getTextureWidth() {
        return (float)getTextures()[0].getWidth() * GameConfig.VIEWPORT_WIDTH / GameConfig.SCREEN_WIDTH;
    }
}
